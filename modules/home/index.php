<div id="content">
    <div id="carrousel">
        ...
        <div id="slide2" class="slide">
        	<div class="visu">
        		<img src="images/carrousel/slide2.png" alt="Personnages de Krysalis" />
            </div>
            <h3 class="title">Titre slide 2</h3>
        </div>
        <div id="slide3" class="slide">
        	<div class="visu">
        		<img src="images/carrousel/slide3.png" alt="Personnages de Krysalis" />
            </div>
            <h3 class="title">Autre titre</h3>
        </div>
        <div id="slide4" class="slide">
        	<div class="visu">
        		<img src="images/carrousel/slide4.png" alt="Personnages de Krysalis" />
            </div>
            <h3 class="title">Changement de contenu du titre</h3>
        </div>
       <!-- <div class="navigation">
            <h3 class="active">les personnages</h3>
            <h3 >oh la belle m&eacute;duse</h3>
            <h3 >les tulipes</h3>
            <h3 >un canyon</h3>
        </div>-->
